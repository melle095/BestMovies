...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        locationColumnHashSet.add(MoviesContract.MoviesEntry.TITLE);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.OVERVIEW);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.POSTER);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.POPULARITY);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.RELEASE_DATE);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.FAVORITES);
        locationColumnHashSet.add(MoviesContract.MoviesEntry.VOTES);
    ...
    */
    ...
    public long testWeatherTable() {
        ...
        Log.d("mytest movies: ", String.valueOf(moviesCursor.getCount() + " " + String.valueOf(moviesValues.size())));
    ...
    public void insertReviews() {
        ...
        long movieRowId = testWeatherTable();
...
//         Make sure we have a valid row ID.
        ...
        long locationRowId;
        locationRowId = db.insert(MoviesContract.ReviewsEntry.TABLE_NAME, null, testValues);
        ...
        Cursor cursor = db.query(
                MoviesContract.ReviewsEntry.TABLE_NAME,  // Table to Query
                null, // all columns
        ...
        assertFalse( "Error: More than one record returned from location query",
                cursor.moveToNext() );
        Log.d("mytest review: ", String.valueOf(cursor.getCount() + " " + String.valueOf(testValues.size())));
        // Sixth Step: Close Cursor and Database
        cursor.close();
        db.close();
